...
{		
	...
	{
		// Check this one-liner the fuck out and weep.
	...
	public Tensor hadamard(Tensor t)
	{
		...
		{
			throw new DimensionError("Computing a Hadamard product requires equal dimensions: ", this, t);
		}
	...
	public Boolean equals(Tensor t, float e)
	{
		if(!Tensors.isomorph(this, t))
		{
			throw new DimensionError("Checking equality requires equal dimensions: ", this, t);
		}
	...
	public float dot(Angular a)
	{
		...
		if(!Tensors.isomorph(this, t))
		{
			throw new DimensionError("Computing a dot product requires equal dimensions: ", this, t);
		}
	...
	@Override
	public Tensor plus(Abelian a)
	{
		Tensor t = (Tensor) a;
		if(!Tensors.isomorph(this, t))
		{
			throw new DimensionError("Computing a sum requires equal dimensions: ", this, t);
		}
