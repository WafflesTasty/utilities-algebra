package waffles.utils.alg.linear.solvers.square.types;
...
import waffles.utils.alg.linear.solvers.exact.types.LUTriangular;
import waffles.utils.alg.linear.solvers.factor.LQRFactor;
import waffles.utils.alg.linear.solvers.square.LeastSquares;
...
/**
 * The {@code LSHouseholder} algorithm solves least squares systems
 * with {@code Householder} triangulization. This method decomposes a
 * matrix {@code M = QR} where Q is a (reduced) {@code Orthogonal} matrix,
 * and R an {@code UpperTriangular} matrix. The {@code Householder} process
 * simultaneously orthogonalizes all columns of M by applying reflections.
 *
 * @author Waffles
 * @since Jul 10, 2018
 * @version 1.0 
