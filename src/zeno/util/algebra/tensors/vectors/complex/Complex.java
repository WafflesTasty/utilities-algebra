...
public class Complex extends Vector2
{
	...
	/**
	 * Performs angular interpolation with a {@code Complex}.
	 * 
	 * @param c  a complex to interpolate to
	 * @param alpha  an interpolation alpha
	 * @return an interpolated complex
	 */
	public Complex alerp(Complex c, float alpha)
    {
		return from(super.alerp(c, alpha));
    }
	
	/**
	 * Performs linear interpolation on the {@code Complex}.
	 * 
	 * @param c  a complex to interpolate to
	 * @param alpha  an interpolation alpha
	 * @return  an interpolated complex
	 */
	public Complex lerp(Complex c, float alpha)
    {
		return from(super.lerp(c, alpha));
    }
